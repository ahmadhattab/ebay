...
class Mage_Sales_Block_Order_Selling extends Mage_Core_Block_Template
{
    ...
    {
        parent::__construct();
        $this->setTemplate('sales/order/selling.phtml');
		$customerId = $this->_getSession();
		$products = Mage::getModel('catalog/product')->getCollection()
				->addAttributeToFilter('seller_id', array('eq'=>$customerId))
        ...
        $orders = Mage::getResourceModel('sales/order_collection')
            ->addFieldToSelect('*')
            ->join('order_item', 'entity_id = order_id')
