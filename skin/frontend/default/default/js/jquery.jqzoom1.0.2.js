	...
	$.fn.jqueryzoom = function(options) {
		...
		$(this).hover(function() {
			...
			if ($("div.zoomdiv").get().length == 0) {
				$(this).after("<div class='zoomdiv'><img class='bigimg' src='$(this).children(/img/).attr(/longdesc/)'/></div>");
		...
		if (settings.preload) {
			...
			$(this).each(function() {
				...
				jQuery('div.jqPreload' + count + '').html(content + '<img src=\"$(this).children(/img/).attr(/longdesc/)\">');
			});
		}
	}
})(jQuery);
